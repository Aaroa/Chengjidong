...
/**
 * 
 * @ClassName: GasStationNearbyAdapter
 * @Description: 附近加油站适配器
 * @author Aaron
 * @date 2015年5月22日 下午2:36:45
 * 
 */
@SuppressLint("InflateParams")
public class GasStationNearbyAdapter extends BaseAdapter {
	...
	public GasStationNearbyAdapter(Context context) {
