...
public final class ISystemTool {
	/**
	 * 指定格式返回当前系统时间
	 */
	...
	public static String getData(String format, long data) {
		SimpleDateFormat df = new SimpleDateFormat(format);
	 ...
	 * @param smsBody
	 */
	public static void sendEmail(Context cxt, String smsBody) {
		Intent email = new Intent(android.content.Intent.ACTION_SEND);
		email.setType("plain/text");
		String[] emailReciver = new String[] {};

		String emailSubject = "";
		String emailBody = smsBody;
		// 设置邮件默认地址
		...
		// 调用系统的邮件系统
		// cxt.startActivity(Intent.createChooser(email, "请选择邮件发送软件"));
		cxt.startActivity(email);
	}
	...
	public static void copyContent(Context context, String msg) {
